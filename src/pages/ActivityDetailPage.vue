<template>
  <div class="page-container" v-if="activity">
    ...
    <section class="py-24 bg-gradient-dark relative overflow-hidden">
      ...
      <div class="container-inner relative z-10">
        <RouterLink to="/activities" class="inline-flex items-center gap-2 text-sm font-body text-tertiary/60 hover:text-primary mb-8 transition-colors">
    ...
    <section class="py-16 bg-secondary/20">
      <div class="container-inner">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <RouterLink v-for="rel in related" :key="rel.id" :to="`/activities/${rel.id}`"
  ...
  <div v-else class="page-container flex items-center justify-center min-h-screen">
    <div class="text-center">
      ...
      <RouterLink to="/activities" class="btn-primary mt-4 inline-flex">Back to Activities</RouterLink>
    </div>
  </div>
</template>
