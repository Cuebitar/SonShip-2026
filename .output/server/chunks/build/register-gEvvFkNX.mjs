...
import { ref, computed, reactive, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, isRef, createSlots, renderSlot, defineComponent, toRef, provide, useSlots, openBlock, createBlock, createCommentVNode, resolveComponent, useAttrs, toValue, inject, getCurrentInstance, h as h$1, watchEffect, normalizeClass, useId, resolveDynamicComponent, watch, Teleport, Fragment, cloneVNode, shallowRef, useSSRContext, nextTick } from 'vue';
import { twJoin } from 'tailwind-merge';
import { a as useI18n, h as appConfig, t as twMerge, m as mergeConfig, f as useAppConfig, g as get, o as omit } from './server.mjs';
import { useDebounceFn } from '@vueuse/core';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderClass, ssrRenderSlot, ssrGetDynamicModelProps, ssrRenderVNode } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { C as serialize, l as defu, y as isEqual } from '../nitro/nitro.mjs';
import { _ as __nuxt_component_0$4 } from './nuxt-link-D22nWayR.mjs';
import __nuxt_component_0$5 from './index-CnGBrS2x.mjs';
...
const config$5 = mergeConfig(appConfig.ui.strategy, appConfig.ui.radio, radio);
const _sfc_main$8 = defineComponent({
  ...
  setup(props, { emit }) {
    var _a;
    const { ui, attrs } = useUI("radio", toRef(props, "ui"), config$5, toRef(props, "class"));
    const inputId = (_a = props.id) != null ? _a : useId();
    const radioGroup2 = inject("radio-group", null);
    const { emitFormChange, color, name } = radioGroup2 != null ? radioGroup2 : useFormGroup(props, config$5);
    const pick = computed({
      get() {
...
const config$4 = mergeConfig(appConfig.ui.strategy, appConfig.ui.radioGroup, radioGroup);
const configRadio = mergeConfig(appConfig.ui.strategy, appConfig.ui.radio, radio);
const _sfc_main$7 = defineComponent({
  components: {
    URadio: __nuxt_component_0$3
  },
  inheritAttrs: false,
  props: {
    modelValue: {
  ...
  emits: ["update:modelValue", "change"],
  setup(props, { emit }) {
    const { ui, attrs } = useUI("radioGroup", toRef(props, "ui"), config$4, toRef(props, "class"));
    const { ui: uiRadio } = useUI("radio", toRef(props, "uiRadio"), configRadio);
    const { emitFormChange, color, name } = useFormGroup(props, config$4, false);
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_URadio = __nuxt_component_0$3;
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: _ctx.ui.wrapper
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const genderOptions = computed(() => [
      { label: t2("register.male"), value: "male" },
      { label: t2("register.female"), value: "female" }
    ]);
    const transportOptions = computed(() => [
      { label: t2("register.car"), value: "car" },
      { label: t2("register.bus"), value: "bus" }
    ]);
    const relationshipOptions = computed(() => [
      { label: t2("register.father"), value: "father" },
      { label: t2("register.mother"), value: "mother" },
      { label: t2("register.guardian"), value: "guardian" },
      { label: t2("register.sibling"), value: "sibling" },
      { label: t2("register.partner"), value: "partner" }
    ]);
    const form = reactive({
      fullName: "",
      ic: "",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_URadioGroup = __nuxt_component_0$2;
      const _component_UTooltip = __nuxt_component_1$1;
      const _component_UButton = __nuxt_component_2;
      const _component_UModal = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container" }, _attrs))}><section class="py-24 bg-gradient-dark relative overflow-hidden"><div class="absolute inset-0 bg-[radial-gradient(circle_at_30%_70%,rgba(230,177,83,0.1),transparent_60%)]"></div><div class="container-inner relative z-10 text-center"><h1 class="section-title mb-4">${ssrInterpolate(unref(t2)("register.title"))}</h1><p class="section-subtitle max-w-xl mx-auto">${ssrInterpolate(unref(t2)("register.subtitle"))}</p></div></section><section class="py-16 bg-dark"><div class="container-inner grid grid-cols-1 lg:grid-cols-3 gap-10"><div class="space-y-4"><h3 class="font-heading font-bold text-primary text-lg">${ssrInterpolate(unref(t2)("register.info_title"))}</h3><div class="card p-6 space-y-4"><div><p class="input-label">\u{1F4C5} ${ssrInterpolate(unref(t2)("register.date"))}</p><p class="font-body text-tertiary">August 28\u201331, 2026</p></div><div class="divider"></div><div><p class="input-label">\u{1F4CD} ${ssrInterpolate(unref(t2)("register.venue"))}</p><p class="font-body text-tertiary">Radiant Retreats Site B, Jalan Utama Janda Baik, Kampung Chemperoh, 28750 Bentong, Pahang</p></div><div class="divider"></div><div><p class="input-label">\u{1F4B0} ${ssrInterpolate(unref(t2)("register.fee"))}</p><p class="font-body text-primary font-bold text-xl">RM 200 (${ssrInterpolate(unref(t2)("register.early_bird"))}, before 31th May)</p><p class="font-body text-primary font-bold text-xl">RM 230 (${ssrInterpolate(unref(t2)("register.normal"))}, before 30th June)</p><p class="font-body text-primary font-bold text-xl">RM 280 (${ssrInterpolate(unref(t2)("register.super_late_bird"))}, from 1st July)</p><p class="font-body text-xs text-tertiary/50 mt-1">${ssrInterpolate(unref(t2)("register.fee_note"))}</p></div><div class="divider"></div><div class="card bg-primary/10 border-primary/30 p-4"><p class="font-body text-sm text-primary">${ssrInterpolate(unref(t2)("register.warning"))}</p></div></div></div><div class="lg:col-span-2"><form class="card p-8 space-y-6"><div class="grid grid-cols-1 md:grid-cols-2 gap-5"><div><label class="input-label">${ssrInterpolate(unref(t2)("register.full_name"))} *</label><input${ssrRenderAttr("value", unref(form).fullName)} required${ssrRenderAttr("placeholder", "e.g. Liam Chen")} class="w-full input"></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.ic_number"))} *</label><input${ssrRenderAttr("value", unref(form).ic)} required placeholder="e.g. 990101-14-5678" class="w-full input"></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-5"><div><label class="input-label">${ssrInterpolate(unref(t2)("register.phone"))} *</label><input${ssrRenderAttr("value", unref(form).phone)} required type="tel" placeholder="e.g. 012-3456789" class="w-full input"></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.email"))} *</label><input${ssrRenderAttr("value", unref(form).email)} required type="email" placeholder="e.g. sonship@megasubangcmc.org.my" class="w-full input"></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-5"><div class="flex flex-col gap-1"><label class="input-label">${ssrInterpolate(unref(t2)("register.gender"))} *</label>`);
      ...
      _push(`</div><div class="flex flex-col gap-1"><label class="input-label flex items-center gap-1">${ssrInterpolate(unref(t2)("register.transportation"))} * `);
      _push(ssrRenderComponent(_component_UTooltip, { text: "Car: Drop off at 4:00 PM. Bus: Pick up at 2:30 PM." }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</label>`);
      _push(ssrRenderComponent(_component_URadioGroup, {
        modelValue: unref(form).transportation,
        "onUpdate:modelValue": ($event) => unref(form).transportation = $event,
        options: unref(transportOptions),
        "option-attribute": "label",
        "value-attribute": "value",
        required: "",
        uiRadio: {
      ...
      _push(`</div></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.important_info"))}</label><textarea${ssrRenderAttr("rows", 3)} class="w-full input" placeholder="Any allergies, medical conditions, dietary needs...">${ssrInterpolate(unref(form).importantInfo)}</textarea></div><div class="divider"></div><h4 class="font-heading font-bold text-tertiary">Emergency Contact</h4><div class="grid grid-cols-1 md:grid-cols-2 gap-5"><div><label class="input-label">${ssrInterpolate(unref(t2)("register.emergency_contact_name"))} *</label><input${ssrRenderAttr("value", unref(form).emergencyContactName)} required${ssrRenderAttr("placeholder", "e.g. Liam Chen")} class="w-full input"></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.emergency_contact_phone"))} *</label><input${ssrRenderAttr("value", unref(form).emergencyContactPhone)} required placeholder="e.g. 012-3456789" class="w-full input"></div></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.emergency_contact_relationship"))} *</label><select class="w-full input" placeholder="Choose One Relationship" required><!--[-->`);
      ssrRenderList(unref(relationshipOptions), (option) => {
        _push(`<option${ssrRenderAttr("value", option.value)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).emergencyContactRelationship) ? ssrLooseContain(unref(form).emergencyContactRelationship, option.value) : ssrLooseEqual(unref(form).emergencyContactRelationship, option.value)) ? " selected" : ""}>${ssrInterpolate(option.label)}</option>`);
      });
      _push(`<!--]--></select></div><div class="divider"></div><h4 class="font-heading font-bold text-tertiary">Additional Questions</h4><div><label class="input-label">${ssrInterpolate(unref(t2)("register.q3"))}</label><input${ssrRenderAttr("value", unref(form).q3)} required placeholder="Playing Guitar..." class="w-full input"></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.q1"))}</label><input${ssrRenderAttr("value", unref(form).q1)} required${ssrRenderAttr("rows", 3)} class="w-full input" placeholder="The Prodigal Son..."></div><div><label class="input-label">${ssrInterpolate(unref(t2)("register.q2"))}</label><input${ssrRenderAttr("value", unref(form).q2)} required${ssrRenderAttr("rows", 2)} class="w-full input" placeholder="Words of Encouragement..."></div><div class="pt-2">`);
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(t2)("register.submit"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(t2)("register.submit")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div></form></div></div></section>`);
      _push(ssrRenderComponent(_component_UModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card p-10 max-w-md text-center border-primary/30 shadow-warm-lg mx-auto"${_scopeId}><div class="text-6xl mb-4 animate-bounce"${_scopeId}>\u{1F389}</div><h3 class="font-heading font-black text-2xl text-primary mb-3"${_scopeId}>${ssrInterpolate(unref(t2)("register.success_title"))}</h3><p class="font-body text-tertiary/80 leading-relaxed mb-6"${_scopeId}>${ssrInterpolate(unref(t2)("register.success_msg"))}</p>`);
            _push2(ssrRenderComponent(_component_UButton, {
              block: "",
              onClick: ($event) => showSuccess.value = false
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t2)("register.success_close"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t2)("register.success_close")), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "card p-10 max-w-md text-center border-primary/30 shadow-warm-lg mx-auto" }, [
                createVNode("div", { class: "text-6xl mb-4 animate-bounce" }, "\u{1F389}"),
                createVNode("h3", { class: "font-heading font-black text-2xl text-primary mb-3" }, toDisplayString(unref(t2)("register.success_title")), 1),
                createVNode("p", { class: "font-body text-tertiary/80 leading-relaxed mb-6" }, toDisplayString(unref(t2)("register.success_msg")), 1),
...
//# sourceMappingURL=register-gEvvFkNX.mjs.map
