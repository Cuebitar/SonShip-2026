import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, ref, computed, hasInjectionContext, inject, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, withCtx, getCurrentScope, toRef, nextTick, isReadonly, toRaw, isRef, useSSRContext, isShallow, isReactive } from 'vue';
import { k as klona, i as defuFn, l as defu, e as createError$1, m as createDefu, s as sanitizeStatusCode, n as getContext, $ as $fetch$1, o as baseURL, q as createHooks, r as executeAsync, t as getRequestProtocol, v as getRequestHeaders, w as getRequestHeader, x as destr, y as isEqual$1, z as setCookie, A as getCookie, B as deleteCookie } from '../nitro/nitro.mjs';
...
const __nuxt_page_meta$4 = { requiresAuth: true };
const __nuxt_page_meta$3 = { requiresAuth: true };
const __nuxt_page_meta$2 = { requiresAuth: true };
const __nuxt_page_meta$1 = { requiresAuth: true };
const __nuxt_page_meta = { requiresAuth: true };
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-aKElRIWt.mjs')
  },
  {
    name: "games",
    path: "/games",
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D0a3DhBf.mjs')
  },
  {
    name: "login",
    path: "/login",
  ...
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-gEvvFkNX.mjs')
  },
  {
    name: "schedule",
    path: "/schedule",
  ...
  },
  {
    name: "activities-id",
    path: "/activities/:id()",
    component: () => import('./_id_-CKEjI7V9.mjs')
  },
  {
    name: "activities",
    path: "/activities",
    component: () => import('./index-Ca0kEdVp.mjs')
  },
  {
...
const useCampersStore = defineStore("campers", () => {
  const campers = ref([]);
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-D93YCjAI.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_3c98b321" */
  )
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CnGBrS2x.mjs').then((r) => r["default"] || r.default || r));
...
const _secondary = { "DEFAULT": "#3A2620", "foreground": "#F6E9D7" };
const _tertiary = "#F6E9D7";
const _highlight = { "red": "#941708", "orange": "#FF6F1E" };
const _dark = "#171717";
const _accent = { "DEFAULT": "#FF9A3C", "foreground": "#F6E9D7" };
const _background = "#F6E9D7";
const _foreground = "#171717";
const _card = { "DEFAULT": "#F6E9D7", "foreground": "#171717" };
const _popover = { "DEFAULT": "#3A2620", "foreground": "#F6E9D7" };
const _muted = { "DEFAULT": "#3A2620", "foreground": "#F6E9D7" };
const _destructive = { "DEFAULT": "#941708", "foreground": "#F6E9D7" };
...
const config = { "inherit": _inherit, "current": _current, "transparent": _transparent, "black": _black, "white": _white, "slate": _slate, "gray": _gray, "zinc": _zinc, "neutral": _neutral, "stone": _stone, "red": _red, "orange": _orange, "amber": _amber, "yellow": _yellow, "lime": _lime, "green": _green, "emerald": _emerald, "teal": _teal, "cyan": _cyan, "sky": _sky, "blue": _blue, "indigo": _indigo, "violet": _violet, "purple": _purple, "fuchsia": _fuchsia, "pink": _pink, "rose": _rose, "primary": _primary, "secondary": _secondary, "tertiary": _tertiary, "highlight": _highlight, "dark": _dark, "accent": _accent, "background": _background, "foreground": _foreground, "card": _card, "popover": _popover, "muted": _muted, "destructive": _destructive, "border": _border, "input": _input, "ring": _ring, "chart": _chart, "cool": _cool };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-eLuI0HYf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-YVFHPKzL.mjs'));
...
export { useI18n as a, useAuthStore as b, useCampersStore as c, useRouter as d, entry_default as default, useRoute as e, useAppConfig as f, get as g, appConfig as h, encodeRoutePath as i, hasProtocol as j, joinURL as k, useNuxtApp as l, mergeConfig as m, navigateTo as n, omit as o, parseQuery as p, useRuntimeConfig as q, resolveRouteObject$1 as r, withoutTrailingSlash as s, twMerge as t, useHead as u, nuxtLinkDefaults as v, withTrailingSlash as w, asyncDataDefaults as x, createError as y };
