...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-5c40c2e1><div class="container-inner h-full flex items-center justify-between" data-v-5c40c2e1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(Firelight))} class="w-8 h-8" alt="Firelight" data-v-5c40c2e1${_scopeId}>`);
      ...
      _push(`<div class="hidden md:flex items-center gap-1" data-v-5c40c2e1><!--[-->`);
      ...
      _push(`<!--]--></div><div class="hidden md:flex items-center gap-3" data-v-5c40c2e1><button class="btn-ghost btn-sm font-heading text-xs px-3 py-1.5 rounded-md" data-v-5c40c2e1>${ssrInterpolate(unref(locale) === "en" ? "\u4E2D\u6587" : "EN")}</button>`);
      if (!unref(auth).isLoggedIn && isCamp.value) {
        ...
        _push(`<div class="relative" data-v-5c40c2e1><button class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-primary/10 hover:bg-primary/20 transition-all" data-v-5c40c2e1><span class="text-lg" data-v-5c40c2e1>${ssrInterpolate((_a = unref(auth).user) == null ? void 0 : _a.avatar)}</span><span class="font-heading font-semibold text-sm text-primary" data-v-5c40c2e1>${ssrInterpolate((_b = unref(auth).user) == null ? void 0 : _b.name.split(" ")[0])}</span>`);
        _push(ssrRenderComponent(unref(ChevronDown), { class: "w-3.5 h-3.5 text-primary/60" }, null, _parent));
        _push(`</button>`);
        if (showDropdown.value) {
          _push(`<div class="absolute right-0 top-full mt-2 w-48 card border border-primary/20 py-1.5 shadow-warm-lg" data-v-5c40c2e1><!--[-->`);
          ...
          _push(`<!--]--><div class="divider my-1.5 mx-3" data-v-5c40c2e1></div><button class="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm font-body text-red-400 hover:bg-red-500/10 transition-all" data-v-5c40c2e1>`);
      ...
      _push(`</div><button class="md:hidden btn-ghost btn-icon p-2" data-v-5c40c2e1>`);
      if (!mobileOpen.value) {
      ...
      _push(`</button></div>`);
      if (mobileOpen.value) {
        _push(`<div class="md:hidden absolute top-16 left-0 right-0 bg-dark/98 backdrop-blur-xl border-b border-primary/10 py-4 px-4 space-y-1" data-v-5c40c2e1><!--[-->`);
        ...
        _push(`<!--]--><div class="divider" data-v-5c40c2e1></div><div class="flex gap-2 pt-1" data-v-5c40c2e1><button class="btn-ghost btn-sm flex-1" data-v-5c40c2e1>${ssrInterpolate(unref(locale) === "en" ? "\u4E2D\u6587" : "EN")}</button>`);
        if (!unref(auth).isLoggedIn && isCamp.value) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/login",
            onClick: ($event) => mobileOpen.value = false,
          ...
          _push(`<button class="btn-danger btn-sm flex-1" data-v-5c40c2e1>${ssrInterpolate(unref(t)("nav.logout"))}</button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5c40c2e1"]]);
const _sfc_main$1 = {
  __name: "AppFooter",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=default-CDxK9bgl.mjs.map
